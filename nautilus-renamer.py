...
class Application():
	...
	pat_rene    = gtk.MenuItem ('/num3+1//ext/')
	...
	pat_rene.set_tooltip_text ("numeros comenzando del 001 sin alterar extension")        
	...
	self.pat_popup.attach (pat_rene,     1, 2, 7, 8)
        ...
        pat_rene.connect ('activate', self.on_popup_activate)
    ...
    def prepare_pat_options (self, button, data=None):
        ...
        self.pat_entry.label = _("/3+1//ext/")
